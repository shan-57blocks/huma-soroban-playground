...
export const networks = {
  testnet: {
    ...
    contractId: "CDK4RTARC3CAIPNPRVN7CJEJEVNUYJSCCIOXIXELFITDOGFZQPD664BT",
  }
} as const

export type ClientDataKey = {tag: "PoolManager", values: void};
...
export interface Client {
   ...
   */
  initialize: ({pool_manager, pool_name, underlying_token, junior_tranche, senior_tranche, tranches_policy}: {pool_manager: string, pool_name: string, underlying_token: string, junior_tranche: Option<string>, senior_tranche: Option<string>, tranches_policy: TranchesPolicyType}, options?: {
    /**
   ...
   */
  send_tokens: ({to, amount}: {to: string, amount: u128}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  get_available_balance: ({fees}: {fees: u128}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
...
export class Client extends ContractClient {
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAgAAAAAAAAAAAAAADUNsaWVudERhdGFLZXkAAAAAAAABAAAAAAAAAAAAAAALUG9vbE1hbmFnZXIA",
        ...
        "",
        ...
        "AAAAAAAAAAAAAAALc2VuZF90b2tlbnMAAAAAAgAAAAAAAAACdG8AAAAAABMAAAAAAAAABmFtb3VudAAAAAAACgAAAAA=",
        ...
        "AAAAAAAAAAAAAAAVZ2V0X2F2YWlsYWJsZV9iYWxhbmNlAAAAAAAAAQAAAAAAAAAEZmVlcwAAAAoAAAABAAAACg==",
